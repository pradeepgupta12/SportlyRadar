...
const Leagues = () => {
  ...
  return (
    <>
      <SEO
        title="Hockey Leagues - Explore Top Leagues Worldwide | SportlyRadar"
        description="Discover and explore the best hockey leagues from around the world including standings, top scorers, recent matches and more on SportlyRadar."
        keywords="hockey leagues, NHL, KHL, SHL, ice hockey, hockey standings, top hockey leagues, sports news"
        canonical="https://www.sportlyradar.com/hockey/leagues"
        url="https://www.sportlyradar.com/hockey/leagues"
        image="https://via.placeholder.com/1200x630?text=Hockey+Leagues" // You can replace with a better default hockey image if available
      />
