...
const LeagueDetail = () => {
    ...
    return (
      <>
        <SEO
          ...
          description="The requested hockey league was not found."
          keywords="hockey, league, not found"
          canonical={`https://www.sportlyradar.com/hockey/leagues/${leagueId}`}
          url={`https://www.sportlyradar.com/hockey/leagues/${leagueId}`}
        />
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50 text-gray-600">
          League not found
        </div>
  ...
  return (
    <>
      <SEO
        title={`${league.name} - Hockey League Details | SportlyRadar`}
        description={league.description}
        keywords={`hockey, ${league.name}, ${league.country}, league, standings, top scorers, matches, sports`}
        canonical={`https://www.sportlyradar.com/hockey/leagues/${leagueId}`}
        image={league.logo}
        url={`https://www.sportlyradar.com/hockey/leagues/${leagueId}`}
      />
