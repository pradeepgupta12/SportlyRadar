...
const FootballRankings = () => {
  ...
  // SEO meta data
  const positionLabel = selectedPosition === 'all' ? 'All Positions' : selectedPosition + 's';
  const seoTitle = `Football Player Rankings | ${positionLabel} | Top Footballers 2026`;
  const seoDescription = `Top football player rankings for ${positionLabel}. View player ratings, goals, assists, market value, and weekly rank changes. Updated January 2026.`;
  const seoKeywords = `football rankings, player ratings, top footballers, best football players, ${positionLabel}, football statistics`;
  const seoImage = "https://sportlyradar.com/football-rankings-og-image.jpg";
