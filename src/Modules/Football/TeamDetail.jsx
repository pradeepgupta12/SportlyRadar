...
const FootballTeamDetail = () => {
  ...
  // SEO data
  const seoTitle = `${team.name} - Football Team Profile, Stats & History | SportlyRadar`;
  const seoDescription = `Complete profile of ${team.name} (${team.nickname}) - ${team.league} team. View squad, matches, trophies, stadium info, current season stats, and team history.`;
  const seoKeywords = `${team.name}, ${team.nickname}, ${team.league} team, football team profile, ${team.city} football, ${team.stadium}, football statistics`;
  const currentUrl = window.location.href;
  const teamImage = team.teamLogo || "https://via.placeholder.com/800x400?text=Football+Team";
