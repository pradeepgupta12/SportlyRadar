...
const FootballTransfers = () => {
  ...
  // SEO data
  const seoTitle = 'Football Transfer News - Latest Signings, Rumors & Completed Deals | SportlyRadar';
  const seoDescription = 'Stay updated with the latest football transfer news, rumors, and completed deals across Premier League, La Liga, Serie A, Bundesliga, Ligue 1, and Saudi Pro League.';
  const seoKeywords = 'football transfers, transfer news, player signings, transfer rumors, football deals, transfer window, soccer transfers, summer transfers, winter transfers';
