...
import LatestNews from '../../data/LatestNews.js';
import { footballLeagueDetails } from '../../data/FootballLeagueDetail.js';
import SEO from '../../components/SEO'; // Adjust the path based on your project structure; assuming src/pages/football/... and src/components/SEO.jsx
...
const FootballLeagueDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50">
      <SEO
        title={`${league.name} - Standings, Top Scorers, Recent Matches | SportlyRadar`}
        description={league.description}
        keywords={`${league.name}, ${league.country} football, league standings, top scorers, recent matches, football league details`}
        canonical={`https://www.sportlyradar.com/football/league/${leagueId}`} // Replace with your actual domain
        image={league.logo || 'https://via.placeholder.com/1200x630?text=SportlyRadar'} // Use league logo or fallback
        url={`https://www.sportlyradar.com/football/league/${leagueId}`} // Replace with your actual domain
      />
      {/* Main Grid Layout */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
