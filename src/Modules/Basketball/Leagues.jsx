...
const Leagues = () => {
  ...
  // SEO meta data
  const seoTitle = "Basketball Leagues | NBA, EuroLeague & Worldwide Leagues | SportlyRadar";
  const seoDescription = "Explore all major basketball leagues worldwide including NBA, EuroLeague, CBA, and more. Get league details, champions, team counts and league information.";
  const seoKeywords = "basketball leagues, NBA, EuroLeague, CBA, NBL, basketball, professional leagues, basketball tournaments";
  const seoImage = "https://sportlyradar.com/basketball-leagues-og-image.jpg";
