...
const LiveScores = () => {
  ...
  // SEO meta data
  const seoTitle = "Live Basketball Scores | Real-Time NBA & EuroLeague Scores | SportlyRadar";
  const seoDescription = "Follow live basketball scores from NBA, EuroLeague and international matches. Get real-time updates, quarter scores, and match statistics.";
  const seoKeywords = "live basketball scores, NBA scores, EuroLeague scores, basketball match updates, live basketball, basketball results, NBA live";
  const seoImage = "https://sportlyradar.com/basketball-live-scores-og-image.jpg";
