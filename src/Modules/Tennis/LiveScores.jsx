...
const LiveScores = () => {
  ...
  // SEO meta data
  const seoTitle = "Live Tennis Scores | Real-Time Match Updates | SportlyRadar";
  const seoDescription = "Follow live tennis scores from ATP, WTA, and Grand Slam tournaments. Get real-time updates, match statistics, and player performances.";
  const seoKeywords = "live tennis scores, ATP scores, WTA scores, tennis match updates, live tennis, tennis tournaments, tennis results";
  const seoImage = "https://sportlyradar.com/tennis-live-scores-og-image.jpg";
