...
//   // Auto-navigate to AllLatestNews when "News" tab is selected
//   useEffect(() => {
//     if (activeTab === 'News') {
//       navigate('/all-latest-news');
//       // Optional: reset tab to previous one after navigation (if you want to come back)
//       // setActiveTab('Info'); // uncomment if you want to reset tab on back navigation
//     }
//   }, [activeTab, navigate]);
...
//                       className={`px-6 py-4 text-sm font-medium whitespace-nowrap transition-colors ${
//                         activeTab === tab
//                           ? 'border-b-4 border-teal-600 text-teal-600 font-semibold'
...
//               {/* All other tabs (except News) show placeholder */}
...
//               {/* News tab is handled via useEffect navigation — no content needed here */}
//               {activeTab === 'News' && (
//                 <div className="text-center py-20 bg-gray-50 rounded-lg">
//                   <p className="text-xl text-gray-600">Redirecting to All Latest News...</p>
//                 </div>
//               )}
//             </div>
//           </div>
...
//                   />
//                   <div className="p-4">
//                     <h4 className="text-base font-semibold text-gray-800 line-clamp-2 mb-2 group-hover:text-teal-700">
//                       {article.title}
//                     </h4>
//                     <p className="text-sm text-gray-600 line-clamp-2 mb-3">
//                       {article.description}
...
import TopStories from '../../data/TopStories.js';
import LatestNews from '../../data/LatestNews.js';
import SEO from '../../components/SEO'; // Assuming this is the same SEO component you used before
...
const ICCMenDetailPage = () => {
  ...
  // Dynamic SEO values based on the match
  const pageTitle = `${team1} vs ${team2} - ${worldCupData.series} ${matchNumber || ''}`;
  const pageDescription = `Follow ${team1} vs ${team2} match details, squads, venue, date & time in ${worldCupData.series}. Live updates, scorecard & more on SportlyRadar.`;
  const canonicalUrl = `https://www.sportlyradar.com/cricket/matches/${matchId}`;
  const ogImage = "https://www.sportlyradar.com/images/cricket-match-og.jpg"; // You can make this dynamic later if you have team-specific images
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        ...
        keywords={`${team1} vs ${team2}, ${worldCupData.series}, cricket match, live score, scorecard, squads, ${team1} cricket, ${team2} cricket`}
