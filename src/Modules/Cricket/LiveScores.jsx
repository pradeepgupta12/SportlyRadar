...
const LiveScores = () => {
  ...
  //                  DYNAMIC SEO
  // ────────────────────────────────────────────────
  const pageTitle = selectedMainTab === 'live'
    ? "Live Cricket Scores Today | Live Matches & Updates | SportlyRadar"
    : selectedMainTab === 'recent'
    ? "Recent Cricket Match Results | Latest Scores | SportlyRadar"
    : "Upcoming Cricket Matches & Fixtures | SportlyRadar";

  const pageDescription = selectedMainTab === 'live'
    ? "Watch live cricket scores, ball-by-ball commentary, current run rates, wickets and match status for all international, league, domestic and women's matches on SportlyRadar."
    : selectedMainTab === 'recent'
    ? "Check latest completed cricket match results, scorecards and highlights from recent international and domestic games."
    : "View upcoming cricket fixtures, match timings, venues and series information for international tours, IPL, BBL, PSL and more.";

  const canonicalUrl = "https://www.sportlyradar.com/live-cricket-scores";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        ...
        keywords="live cricket score, live scores today, cricket live match, live cricket streaming, recent cricket results, upcoming cricket matches, cricket scorecard, IPL live, international cricket live, women's cricket live"
        canonical={canonicalUrl}
        image="https://www.sportlyradar.com/images/live-cricket-scores-og.jpg"
        url={canonicalUrl}
        type="website"
      />
