...
const ICCRankings = () => {
  ...
  const getPageTitle = () => {
    if (isPlayers) {
      return `ICC Men's ${formatDisplay} ${activeCategory} Player Rankings | SportlyRadar`;
    }
    return `ICC Men's ${formatDisplay} Team Rankings | SportlyRadar`;
  };

  const getPageDescription = () => {
    if (isPlayers) {
      return `Latest ICC Men's ${formatDisplay} ${activeCategory.toLowerCase()} player rankings with ratings and career bests. Updated ${lastUpdated}. Follow top cricketers performance on SportlyRadar.`;
    }
    return `Current ICC Men's ${formatDisplay} team rankings with matches, points and ratings. Latest updates as of ${lastUpdated} on SportlyRadar.`;
  };

  const canonicalUrl = "https://www.sportlyradar.com/cricket/rankings";
  ...
  return (
    <main className="w-full max-w-full lg:max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 min-h-screen">
      <SEO
        ...
        keywords="ICC rankings, ICC team rankings, ICC player rankings, Test rankings, ODI rankings, T20I rankings, cricket rankings, ICC batting rankings, ICC bowling rankings, ICC all-rounder rankings"
        canonical={canonicalUrl}
        image="https://www.sportlyradar.com/images/icc-rankings-og.jpg"
        url={canonicalUrl}
        type="website"
      />
