...
export default function CricketLeagues() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <SEO
        title="Cricket Leagues | SportlyRadar"
        description="Follow the world's most exciting cricket leagues with live scores, standings, and statistics on SportlyRadar."
        keywords="cricket leagues, IPL, BBL, PSL, cricket scores, cricket standings, live cricket updates"
        canonical="https://www.sportlyradar.com/cricket-leagues"
        image="https://www.sportlyradar.com/images/cricket-leagues-og.jpg"
        url="https://www.sportlyradar.com/cricket-leagues"
      />
      {/* Hero Section - Same width as filters section */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
