...
export default function LeagueDetail() {
  ...
  const pageTitle = `${leagueName} | Live Scores, Standings, Matches & Stats | SportlyRadar`;
  const pageDescription = `Explore ${leagueName} - ${league.country || ''} ${league.format || ''} cricket league. Get latest standings, recent & upcoming matches, top performers, venues and more on SportlyRadar.`;
  const canonicalUrl = `https://www.sportlyradar.com/leagues/${leagueId}`;
  const ogImage = league.logo || "https://www.sportlyradar.com/images/cricket-league-default-og.jpg";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <SEO
        ...
        keywords={`${leagueName}, ${leagueName} standings, ${leagueName} matches, ${leagueName} fixtures, ${leagueName} results, cricket league, ${league.country || ''} cricket, ${league.format || ''} cricket`}
