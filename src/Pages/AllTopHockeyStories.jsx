...
// const AllTopHockeyStories = () => {
//   const navigate = useNavigate();
//   const stories = TopHockeyStories.data.TopHockeyStories || [];
...
// export default AllTopHockeyStories;
...
const AllTopHockeyStories = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      {/* SEO Component */}
      <SEO 
        title="Top Hockey Stories | SportlyRadar"
        description="Discover the latest hockey stories, match highlights, player performances, tournament updates, and exclusive hockey content from NHL and leagues worldwide."
        keywords="hockey stories, hockey news, NHL news, match highlights, player performances, tournament updates, hockey content, ice hockey, field hockey"
        canonical={window.location.href}
        image="https://sportlyradar.com/hockey-stories-og-image.jpg"
