...
const HockeyStoryDetails = () => {
  ...
  const seoTitle = `${story.title} | Hockey News | SportlyRadar`;
  const seoDescription = story.description || `Read the latest hockey story: ${story.title}. Get insights, analysis and updates from the world of hockey.`;
  const seoKeywords = `hockey, ${story.title}, hockey news, sports story, ${story.title.split(' ').slice(0, 5).join(', ')}, hockey updates, hockey analysis, NHL news`;
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <SEO 
        ...
        image={story.image || "https://sportlyradar.com/hockey-story-og-image.jpg"}
        url={window.location.href}
        type="article"
        publishedTime={new Date(story.date).toISOString()}
        author="SportlyRadar Hockey Team"
      />
