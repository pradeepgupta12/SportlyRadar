...
// const AllTopFootballStories = () => {
//   const navigate = useNavigate();
//   const stories = TopFootballStories.data.TopFootballStories;
...
// export default AllTopFootballStories;
...
const AllTopFootballStories = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* SEO Component */}
      <SEO 
        title="Top Football Stories | SportlyRadar"
        description="Get the latest football stories, match highlights, transfer news, player analysis, and exclusive football content from Premier League, Champions League and leagues worldwide."
        keywords="football stories, football news, match highlights, transfer news, player analysis, Premier League, Champions League, football updates, soccer stories"
        canonical={window.location.href}
        image="https://sportlyradar.com/football-stories-og-image.jpg"
