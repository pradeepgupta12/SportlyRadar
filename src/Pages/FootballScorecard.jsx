...
const FootballScorecard = () => {
  ...
  const seoTitle = `${matchData.teams.home.name} vs ${matchData.teams.away.name} - Football Scorecard | ${matchData.competition} | SportlyRadar`;
  const seoDescription = `Live football match between ${matchData.teams.home.name} and ${matchData.teams.away.name}. Get real-time scores, player stats, match commentary, and highlights from ${matchData.competition}.`;
  const seoKeywords = `${matchData.teams.home.name}, ${matchData.teams.away.name}, football scorecard, ${matchData.competition}, live football scores, player stats, match highlights, football match`;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <SEO 
        ...
        image={matchData.images.team1_logo || "https://sportlyradar.com/football-scorecard-og-image.jpg"}
