...
// <span className="text-indigo-600 text-sm font-semibold">{blog.categoryLabel}</span>
// <h1 className="text-3xl font-bold mt-2">{blog.title}</h1>
// <p className="text-gray-400 text-sm mt-1">{blog.author} • {blog.readTime}</p>
// <img src={blog.thumbnail} alt={blog.title} className="w-full h-72 object-cover rounded-xl my-6" />
